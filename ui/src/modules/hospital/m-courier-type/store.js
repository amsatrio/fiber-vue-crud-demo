...
let base_url = "http://localhost:9001/v1/hospital/m-courier-type";

export const useMCourierTypeStore = defineStore('mcouriertype', {
    state: () => ({
        data: { courierId: null, name: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
