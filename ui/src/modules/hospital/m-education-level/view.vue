...
import { useMEducationLevelStore } from '@/modules/hospital/m-education-level/store';
import { computed, onMounted, ref } from 'vue';

const store = useMEducationLevelStore();
...
const openDetailModal = (item: any) => {
  ...
  (document.getElementById('m_education_level_detail_modal') as HTMLDialogElement).showModal();
};
...
const openModal = (item: any = null) => {
  ...
  (document.getElementById('m_education_level_modal') as HTMLDialogElement).showModal();
};

const submitForm = async () => {
  await store.saveData(selectedId.value);
  (document.getElementById('m_education_level_modal') as HTMLDialogElement).close();
};
...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">M Education Level Management</h1>
    ...
    <!-- Details View Modal -->
    <dialog id="m_education_level_detail_modal" class="modal">
      <div class="modal-box max-w-md">
        <h3 class="font-bold text-xl mb-4">M Education Level Details</h3>
