...
let base_url = "http://localhost:9001/v1/hospital/t-reset-password";

export const useTResetPasswordStore = defineStore('tresetpassword', {
    state: () => ({
        data: { oldPassword: '', newPassword: '', resetFor: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
