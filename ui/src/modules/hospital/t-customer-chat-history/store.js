...
let base_url = "http://localhost:9001/v1/hospital/t-customer-chat-history";

export const useTCustomerChatHistoryStore = defineStore('tcustomerchathistory', {
    state: () => ({
        data: { customerChatId: null, chatContent: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
        ...
        async saveData(id) {
            ...
            try {
                await fetch(url, {
                    ...
                    body: JSON.stringify({
                        id: id || undefined,
                        customerChatId: this.data.customerChatId,
