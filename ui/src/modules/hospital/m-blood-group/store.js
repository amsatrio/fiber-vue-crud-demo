...
let base_url = "http://localhost:9001/v1/hospital/m-blood-group";

export const useMBloodGroupStore = defineStore('mbloodgroup', {
    state: () => ({
        data: { code: '', descrtiption: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
            ...
            try {
                await fetch(url, {
                    ...
                    body: JSON.stringify({
                        id: id || undefined,
                        code: this.data.code,
                    descrtiption: this.data.descrtiption
                    }),
                });
