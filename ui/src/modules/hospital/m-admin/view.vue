...
import { useMAdminStore } from '@/modules/hospital/m-admin/store';
import { computed, onMounted, ref } from 'vue';

const store = useMAdminStore();
...
const openDetailModal = (item: any) => {
  ...
  (document.getElementById('m_admin_detail_modal') as HTMLDialogElement).showModal();
};
...
const openModal = (item: any = null) => {
  ...
  if (item) {
    ...
    store.data = { biodataId: null, code: '' };
  }
  (document.getElementById('m_admin_modal') as HTMLDialogElement).showModal();
};

const submitForm = async () => {
  await store.saveData(selectedId.value);
  (document.getElementById('m_admin_modal') as HTMLDialogElement).close();
};
...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">M Admin Management</h1>
    ...
    <!-- Details View Modal -->
    <dialog id="m_admin_detail_modal" class="modal">
      <div class="modal-box max-w-md">
        <h3 class="font-bold text-xl mb-4">M Admin Details</h3>
    ...
    <dialog id="m_admin_modal" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">{ isEdit ? 'Edit' : 'Create' } M Admin</h3>
