...
let base_url = "http://localhost:9001/v1/hospital/t-courier-discount";

export const useTCourierDiscountStore = defineStore('tcourierdiscount', {
    state: () => ({
        data: { courierTypeId: null, value: null },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
        ...
        async saveData(id) {
            ...
            try {
                await fetch(url, {
                    ...
                    body: JSON.stringify({
                        id: id || undefined,
                        courierTypeId: this.data.courierTypeId,
