...
import { useMCustomerRelationStore } from '@/modules/hospital/m-customer-relation/store';
import { computed, onMounted, ref } from 'vue';

const store = useMCustomerRelationStore();
...
const openDetailModal = (item: any) => {
  ...
  (document.getElementById('m_customer_relation_detail_modal') as HTMLDialogElement).showModal();
};
...
const openModal = (item: any = null) => {
  ...
  (document.getElementById('m_customer_relation_modal') as HTMLDialogElement).showModal();
};

const submitForm = async () => {
  await store.saveData(selectedId.value);
  (document.getElementById('m_customer_relation_modal') as HTMLDialogElement).close();
};
...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">M Customer Relation Management</h1>
    ...
    <!-- Details View Modal -->
    <dialog id="m_customer_relation_detail_modal" class="modal">
      <div class="modal-box max-w-md">
        <h3 class="font-bold text-xl mb-4">M Customer Relation Details</h3>
    ...
    <dialog id="m_customer_relation_modal" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">{ isEdit ? 'Edit' : 'Create' } M Customer Relation</h3>
