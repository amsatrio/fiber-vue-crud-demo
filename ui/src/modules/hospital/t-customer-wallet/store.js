...
let base_url = "http://localhost:9001/v1/hospital/t-customer-wallet";

export const useTCustomerWalletStore = defineStore('tcustomerwallet', {
    state: () => ({
        data: { customerId: null, pin: '', balance: null, barcode: '', points: null },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
