...
let base_url = "http://localhost:9001/v1/hospital/t-customer-va-history";

export const useTCustomerVaHistoryStore = defineStore('tcustomervahistory', {
    state: () => ({
        data: { customerVaId: null, amount: null, expiredOn: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
        ...
        async saveData(id) {
            ...
            try {
                await fetch(url, {
                    ...
                    body: JSON.stringify({
                        id: id || undefined,
                        customerVaId: this.data.customerVaId,
