...
let base_url = "http://localhost:9001/v1/hospital/m-medical-item-segmentation";

export const useMMedicalItemSegmentationStore = defineStore('mmedicalitemsegmentation', {
    state: () => ({
        data: { name: '' },
        pagedata: [],
        loading: false,
