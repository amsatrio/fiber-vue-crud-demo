...
import { useMMedicalItemSegmentationStore } from '@/modules/hospital/m-medical-item-segmentation/store';
import { computed, onMounted, ref } from 'vue';

const store = useMMedicalItemSegmentationStore();
...
const openDetailModal = (item: any) => {
  ...
  (document.getElementById('m_medical_item_segmentation_detail_modal') as HTMLDialogElement).showModal();
};
...
const openModal = (item: any = null) => {
  ...
  (document.getElementById('m_medical_item_segmentation_modal') as HTMLDialogElement).showModal();
};

const submitForm = async () => {
  await store.saveData(selectedId.value);
  (document.getElementById('m_medical_item_segmentation_modal') as HTMLDialogElement).close();
};
...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">M Medical Item Segmentation Management</h1>
    ...
    <!-- Details View Modal -->
    <dialog id="m_medical_item_segmentation_detail_modal" class="modal">
      <div class="modal-box max-w-md">
        <h3 class="font-bold text-xl mb-4">M Medical Item Segmentation Details</h3>
    ...
    <dialog id="m_medical_item_segmentation_modal" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">{{ isEdit ? 'Edit' : 'Create' }} M Medical Item Segmentation</h3>
