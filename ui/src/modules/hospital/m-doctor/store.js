...
let base_url = "http://localhost:9001/v1/hospital/m-doctor";

export const useMDoctorStore = defineStore('mdoctor', {
    state: () => ({
        data: { biodataId: null, strCode: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
