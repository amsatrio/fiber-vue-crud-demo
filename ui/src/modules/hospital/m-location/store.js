...
let base_url = "http://localhost:9001/v1/hospital/m-location";

export const useMLocationStore = defineStore('mlocation', {
    state: () => ({
        data: { name: '', parentId: null, locationLevelId: null },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
        ...
        async saveData(id) {
            ...
            try {
                await fetch(url, {
                    ...
                    locationLevelId: this.data.locationLevelId
                    }),
                });
