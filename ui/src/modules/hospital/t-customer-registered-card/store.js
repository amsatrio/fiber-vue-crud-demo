...
let base_url = "http://localhost:9001/v1/hospital/t-customer-registered-card";

export const useTCustomerRegisteredCardStore = defineStore('tcustomerregisteredcard', {
    state: () => ({
        data: { customerId: null, cardNumber: '', validityPeriod: '', cvv: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
