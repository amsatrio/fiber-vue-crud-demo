...
let base_url = "http://localhost:9001/v1/hospital/t-customer-va";

export const useTCustomerVaStore = defineStore('tcustomerva', {
    state: () => ({
        data: { customerId: null, vaNumber: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
