...
import { useMWalletDefaultNominalStore } from '@/modules/hospital/m-wallet-default-nominal/store';
import { computed, onMounted, ref } from 'vue';

const store = useMWalletDefaultNominalStore();
...
const openDetailModal = (item: any) => {
  ...
  (document.getElementById('m_wallet_default_nominal_detail_modal') as HTMLDialogElement).showModal();
};
...
const openModal = (item: any = null) => {
  ...
  (document.getElementById('m_wallet_default_nominal_modal') as HTMLDialogElement).showModal();
};

const submitForm = async () => {
  await store.saveData(selectedId.value);
  (document.getElementById('m_wallet_default_nominal_modal') as HTMLDialogElement).close();
};
...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">M Wallet Default Nominal Management</h1>
    ...
    <!-- Details View Modal -->
    <dialog id="m_wallet_default_nominal_detail_modal" class="modal">
      <div class="modal-box max-w-md">
        <h3 class="font-bold text-xl mb-4">M Wallet Default Nominal Details</h3>
    ...
    <dialog id="m_wallet_default_nominal_modal" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">{{ isEdit ? 'Edit' : 'Create' }} M Wallet Default Nominal</h3>
