...
let base_url = "http://localhost:9001/v1/hospital/t-doctor-treatment";

export const useTDoctorTreatmentStore = defineStore('tdoctortreatment', {
    state: () => ({
        data: { doctorId: null, name: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
