...
let base_url = "http://localhost:9001/v1/hospital/m-menu";

export const useMMenuStore = defineStore('mmenu', {
    state: () => ({
        data: { name: '', url: '', parentId: null, bigIcon: '', smallIcon: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
