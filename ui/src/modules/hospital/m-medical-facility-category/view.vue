...
import { useMMedicalFacilityCategoryStore } from '@/modules/hospital/m-medical-facility-category/store';
import { computed, onMounted, ref } from 'vue';

const store = useMMedicalFacilityCategoryStore();
...
const openDetailModal = (item: any) => {
  ...
  (document.getElementById('m_medical_facility_category_detail_modal') as HTMLDialogElement).showModal();
};
...
const openModal = (item: any = null) => {
  ...
  (document.getElementById('m_medical_facility_category_modal') as HTMLDialogElement).showModal();
};

const submitForm = async () => {
  await store.saveData(selectedId.value);
  (document.getElementById('m_medical_facility_category_modal') as HTMLDialogElement).close();
};
...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">M Medical Facility Category Management</h1>
    ...
    <!-- Details View Modal -->
    <dialog id="m_medical_facility_category_detail_modal" class="modal">
      <div class="modal-box max-w-md">
        <h3 class="font-bold text-xl mb-4">M Medical Facility Category Details</h3>
    ...
    <dialog id="m_medical_facility_category_modal" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">{ isEdit ? 'Edit' : 'Create' } M Medical Facility Category</h3>
