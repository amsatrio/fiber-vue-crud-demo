...
let base_url = "http://localhost:9001/v1/hospital/m-medical-facility-category";

export const useMMedicalFacilityCategoryStore = defineStore('mmedicalfacilitycategory', {
    state: () => ({
        data: { name: '' },
        pagedata: [],
        loading: false,
