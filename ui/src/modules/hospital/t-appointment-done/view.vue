...
import { useTAppointmentDoneStore } from '@/modules/hospital/t-appointment-done/store';
import { computed, onMounted, ref } from 'vue';

const store = useTAppointmentDoneStore();
...
const openDetailModal = (item: any) => {
  ...
  (document.getElementById('t_appointment_done_detail_modal') as HTMLDialogElement).showModal();
};
...
const openModal = (item: any = null) => {
  ...
  (document.getElementById('t_appointment_done_modal') as HTMLDialogElement).showModal();
};

const submitForm = async () => {
  await store.saveData(selectedId.value);
  (document.getElementById('t_appointment_done_modal') as HTMLDialogElement).close();
};
...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      <h1 class="text-2xl font-bold">T Appointment Done Management</h1>
    ...
    <!-- Details View Modal -->
    <dialog id="t_appointment_done_detail_modal" class="modal">
      <div class="modal-box max-w-md">
        <h3 class="font-bold text-xl mb-4">T Appointment Done Details</h3>
    ...
    <dialog id="t_appointment_done_modal" class="modal">
      <div class="modal-box">
        <h3 class="font-bold text-lg">{{ isEdit ? 'Edit' : 'Create' }} T Appointment Done</h3>
