...
let base_url = "http://localhost:9001/v1/hospital/t-doctor-office";

export const useTDoctorOfficeStore = defineStore('tdoctoroffice', {
    state: () => ({
        data: { doctorId: null, medicalFacilityId: null, specialization: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
