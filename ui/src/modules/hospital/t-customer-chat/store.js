...
let base_url = "http://localhost:9001/v1/hospital/t-customer-chat";

export const useTCustomerChatStore = defineStore('tcustomerchat', {
    state: () => ({
        data: { customerId: null, doctorId: null },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
