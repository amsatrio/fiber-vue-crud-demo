...
let base_url = "http://localhost:9001/v1/hospital/t-customer-custom-nominal";

export const useTCustomerCustomNominalStore = defineStore('tcustomercustomnominal', {
    state: () => ({
        data: { customerId: null, nominal: null },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
