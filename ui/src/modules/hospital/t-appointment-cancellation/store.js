...
let base_url = "http://localhost:9001/v1/hospital/t-appointment-cancellation";

export const useTAppointmentCancellationStore = defineStore('tappointmentcancellation', {
    state: () => ({
