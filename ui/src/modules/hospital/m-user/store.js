...
let base_url = "http://localhost:9001/v1/hospital/m-user";

export const useMUserStore = defineStore('muser', {
    state: () => ({
        data: { biodataId: null, roleId: null, email: '', password: '', loginAttempt: null, isLocked: false, lastLogin: '' },
        pagedata: [],
        loading: false,
        pagination: {
            totalPages: 0,
        ...
        async saveData(id) {
            ...
            try {
                await fetch(url, {
                    ...
                    loginAttempt: this.data.loginAttempt,
